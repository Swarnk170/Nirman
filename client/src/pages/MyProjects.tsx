            ...
            <div className='flex flex-wrap gap-3.5'>
              {
                projects.map((project)=>(
                  ...
                  }} className='relative group w-72 max-sm:mx-auto cursor-pointer bg-gray-900/60 border border-gray-700 rounded-lg overflow-hidden shadow-md group hover:shadow-indigo-700/30 hover:border-indigo-800/80 transition-all duration-300 ' key={project.id}>
    ...
    <p>No Preview</p>
                      ...
                      <div className='p-4 text-white bg-linear-180 from-transparent group-hover:from-indigo-950 to-transparent transition-colors'>
                        ...
                        <div onClick={(e)=>{
                          ...
                          <button onClick={()=>{
                            navigate(`/projects/${project.id}`)
                          }}className='px-3 py-1.5 bg-white/10 hover:bg-white/15 rounded-md transition-all'>Open</button>
                          </div>
                        </div>
                      </div>
