            ...
            <div className='flex flex-wrap gap-3.5'>
              {
                projects.map((project)=>(
                  <Link to={`/view/${project.id}`} target='_blank' className='w-72 max-sm:mx-auto cursor-pointer bg-gray-900/60 border border-gray-700 rounded-lg overflow-hidden group hover:border-indigo-800/80 transition-all duration-300 ' key={project.id}>
